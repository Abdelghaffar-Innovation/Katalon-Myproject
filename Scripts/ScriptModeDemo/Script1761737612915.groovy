...
WebUI.click(findTestObject('Object Repository/Page_Logged In Successfully  Practice Test Automation/a_Congratulations student. You successfully logged in_wp-block-button__link has-text-color has-background has-very-dark-gray-background-color'))
